...
function checkF_name(){
    var pattern = /^[a-zA-Z ]+$/;
    var x = document.forms["personal_form"]["fname"].value;
    var y = document.getElementById("errf_name");
    if(x=="") {y.innerHTML=""; return true;}
    if(!x.match(pattern)) { alert('only characters are allowed');
        x=""; y.innerHTML="*Only characters are allowed";   return false;}
    else if(x.length>30) {alert('*Max 30 characters');
        x=""; y.innerHTML="*Max 30 characters";  return false;}
    else{y.innerHTML=""; return true;}
}

function checkS_name(){
    var pattern = /^[a-zA-Z ]+$/;
    var x = document.forms["personal_form"]["lname"].value;
    var y = document.getElementById("errs_name");
    if(x=="") {y.innerHTML=""; return true;}
    else if(!x.match(pattern)) {alert('only characters are allowed');
        x=""; y.innerHTML="*Only characters are allowed";   return false;}
    else if(x.length>30) {alert('*Max 30 characters');
        x=""; y.innerHTML="*Max 30 characters";  return false;}
    else{y.innerHTML=""; return true;}
...
function checkUName(){
    var pattern = /^[a-zA-Z ]+$/;
    var x = document.forms["personal_form"]["uname"].value;
    var y = document.getElementById("errf_name");
    if(x=="") {y.innerHTML=""; return true;}
    if(!x.match(pattern)) {
...
function checkMYear(){
    var pattern = /^[0-9]+$/;
    var x = document.forms["personal_form"]["m_year"].value;
...
function checkDOB(){
    var pattern = /^[0-9]+$/;
    var x = document.forms["personal_form"]["dob"].value;
    var y = document.getElementById("errb_year");
    if(x=="")   { y.innerHTML="";  return true;}
    if(!x.match(pattern)) {
        x=""; y.innerHTML="*Only Numbers are allowed";   return false;}
    if(parseInt(x)<1950 || isNaN(x) || x.length>4) {x=""; y.innerHTML="*Invalid dob";   return false;}
    y.innerHTML=""; return true;
}
...
function checkMCGPA(){
    ...
    var per = /[%]/;
    var x = document.forms["personal_form"]["m_cgpa"].value;
...
function checkBCGPA(){
    ...
    var pattern = /^([0-9]){1,2}([.]){1}([0-9]){1,2}$/;
    var per = /[%]/;
    var x = document.forms["personal_form"]["b_cgpa"].value;
...
function checkBasic(){
    var pattern = /^[0-9]+$/;
    var x = document.forms["personal_form"]["basic"].value;
...
function checkHRA(){
    var pattern = /^[0-9]+$/;
    var x = document.forms["personal_form"]["hra"].value;
...
function checkConveyance(){
    var pattern = /^[0-9]+$/;
    var x = document.forms["personal_form"]["conveyance"].value;
...
function checkMedical(){
    var pattern = /^[0-9]+$/;
    var x = document.forms["personal_form"]["medical"].value;
...
function checkSpecial(){
    var pattern = /^[0-9]+$/;
    var x = document.forms["personal_form"]["special"].value;
...
function checkProvident(){
    var pattern = /^[0-9]+$/;
    var x = document.forms["personal_form"]["provident"].value;
...
function checkBankName(){
    var pattern = /^[a-zA-Z ]+$/;
    var x = document.forms["personal_form"]["bankname"].value;
...
function checkAccount(){
    var pattern = /^[0-9]+$/;
    var x = document.forms["personal_form"]["account"].value;
...
function checkPAN(){
    ...
    var x = document.forms["personal_form"]["pan"].value;
...
<body> 
    ...
    <form action="" method="POST" enctype="multipart/form-data" id="add_emp_form" name="personal_form">
        ...
        <div class="box">
            <div class="form-group">  
                  <div class="row">
                     ...
                     <div class="col-md-3"><input type="text" class="form-control" id="fname" placeholder="Enter first name" name="fname" pattern=[A-Za-z]{2,30} title="Only alphabet" onblur=checkF_name() required></div>                 
                     <div class="col-md-2 text-right"><label for="lname">&nbsp;&nbsp;Last&nbsp;Name<span>&#42;</span></label></div>
                     <div class="col-md-3"><input type="text" class="form-control" id="lname" placeholder="Enter last name" name="lname" pattern=[A-Za-z]{2,30} title="Only alphabet" onblur="checkS_name()" required></div>    
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-5">
                    <input type="text" class="form-control has-success" id="uname" placeholder="Enter username" name="uname" onblur="checkUName()"  required></div> 
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-5"><input type="text" class="form-control" onblur="checkMobile()" id="mobile" placeholder="Enter mobile number" name="mobile" onkeypress="return( event.charCode >47 && event.charCode < 58)" maxlength="10" minlength="10" required></div> 
